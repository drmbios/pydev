...
int main(int argc, char **argv) {
    ...
    if (strlen(argv[2]) == 0 || strlen(argv[2]) > 512 || argv[2][0] == '-') {
        fputs("invalid package specification length\n", stderr); return 2;
    }
    install_args[0] = "python3"; install_args[1] = "-m"; install_args[2] = "pip";
    install_args[3] = "install"; install_args[4] = "--"; install_args[5] = argv[2]; install_args[6] = NULL;
    search_args[0] = "python3"; search_args[1] = "-m"; search_args[2] = "pip";
    search_args[3] = "index"; search_args[4] = "versions"; search_args[5] = "--";
    search_args[6] = argv[2]; search_args[7] = NULL;
